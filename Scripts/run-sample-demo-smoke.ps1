...
Write-Host "4. Click Check Dataset Before Test, then Run Batch Inspection."
Write-Host "5. Verify rows, OK/NG/REVIEW, false calls, possible escapes, selected-row preview, CSV export, annotated export, and validation package export."
Write-Host "6. Export & Trace: run Performance Benchmark against '$imagesDir'."
Write-Host "7. Open validation_summary.html, customer_validation_report.html, benchmark_report.html, benchmark_results.csv, and limitations.txt."
Write-Host ""
